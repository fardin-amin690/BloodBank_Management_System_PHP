...
<body>
    ...
    <div>
        <form action="../../controllers/new-patientController.php" method="post" class="form-container row g-3">
            ...
            <div class="horizontal-buttons" ;>
                <button type="submit" name="new-patient-submit" class="btn btn-primary">Submit</button>
